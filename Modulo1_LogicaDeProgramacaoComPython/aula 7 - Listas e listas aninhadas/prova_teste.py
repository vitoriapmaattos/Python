"""
Neste desafio, você e sua equipe irão construir um sistema básico para
gerenciar livros em uma biblioteca.
Os livros serão armazenados em um dicionário, onde cada chave é um
ID único do livro (um número inteiro) e o valor é outro dicionário contendo
